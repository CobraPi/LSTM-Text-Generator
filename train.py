...
def train_new_trump_model():
    ...
    bot = TwitterBot(checkpoint_name="TRUMP", embedding=True, model_layers=2)
...
def train_new_cambrasine_model():
    current_time = datetime.now()
    bot = TwitterBot(checkpoint_name="CAMBRASINE", embedding=True, model_layers=2)
...
def train_new_alice_model():
    current_time = datetime.now()
    bot = TwitterBot(checkpoint_name="ALICE", embedding=True, model_layers=2)
...
def train_new_bible_model():
    current_time = datetime.now()
    bot = TwitterBot(checkpoint_name="BIBLE", embedding=True, model_layers=2)
...
def train_new_blake_model():
    current_time = datetime.now()
    bot = TwitterBot(checkpoint_name="BLAKE", embedding=True, model_layers=2)
...
def train_new_odyssey_model():
    current_time = datetime.now()
    bot = TwitterBot(checkpoint_name="ODYSSEY", embedding=True, model_layers=2)
